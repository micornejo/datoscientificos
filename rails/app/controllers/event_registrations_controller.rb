class EventRegistrationsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @event_registration.save
        format.html { redirect_to @event_registration.event_url, notice: 'Event registration was successfully created.' }
        format.json { render action: 'show', status: :created, location: @event_registration }
      else
        format.html { redirect_to @event_registration.event_url }
  ...
  private
    ...
    def event_registration_params
      params.require(:event_registration).permit(:user_id, :event_url)
    end
end
